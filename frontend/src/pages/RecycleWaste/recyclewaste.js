...
export class RecycleWaste extends Component {
    ...
    componentDidMount() {
      ...
      handleImageClick = (event) => {
        ...
        const isLowBattery = currentSrc.includes('BrokenEmptyBottle.png');
        event.target.src = isLowBattery ? './img/BrokenBottle.png' : './img/BrokenEmptyBottle.png';
      }
  ...
  render() {
    return (
      <>
        ...
        <div className='penis'>
         <img src='./img/BrokenBottle.png' alt='' className='balls'/>
          <div className='nuts'>Glass Waste</div>
        </div>

        <div className='penis-1'>
         <img src='./img/BrokenEmptyBottle.png' alt='' className='balls-1'/>
         <img src='./img/BrokenEmptyBottle.png' alt='' className='balls-1'/>
         <img src='./img/BrokenEmptyBottle.png' alt='' className='balls-1'/>
         <img src='./img/BrokenEmptyBottle.png' alt='' className='balls-1'/>
         <img src='./img/BrokenEmptyBottle.png' alt='' className='balls-1'/>
  ...
  <div className="item-wrapper">
    <div className="item-count">
      <img src="./img/BrokenBottle.png" alt="Item 1 icon" className="item-icon" />
  ...
  <div className="item-wrapper">
    <div className="item-count">
      <img src="./img/BrokenBottle.png" alt="Item 2 icon" className="item-icon" />
  ...
  <div className="item-wrapper">
    <div className="item-count">
      <img src="./img/BrokenBottle.png" alt="Item 3 icon" className="item-icon" />
